          ...
          <Header/> 
            ...
            <div className="main-container">
              <aside className="sidebar">
                ...
                <a className="active" href="../html/yalepublication.html"><FontAwesomeIcon icon={faFileText}/>  PUBLICATIONS</a>
                ...
                <button onClick={clickme}>Hello in Thai</button>
              </aside>
                ...
                <div className="column">
                  <div className="scrollpost">
                    ...
                    <div className="scrollpost-post">
                      <p>
                        orem ipsum dolor sit amet, consectetur adipiscing elit. Proin imperdiet 
                      ...
                      <img className="img-post" src={windowWall} alt="Wallpaper" />
                  ...
                  <div className="column2">
                    <div className="pubscrollpost-right"><header className="pubsideheader">“News from news haven” archive</header>
                      <div className="apply-post">
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet,
                          nulla et dictum interdum, nisi lorem egestas vitae scel<span id="admiss">...</span><span id="more">
                        ...
                        <button onclick="mytextscrollFunction()" id="myBtn">Read more</button>
                      </div>
                    </div>
